...
(() => {
  ...
  const GROWTH_LAYOUT = {
    /* 넓은 화면은 두 팔로 나눈다. 앞 네 사건은 왼쪽 아래에서 오르며 라벨을
       오른쪽으로, 뒤 세 사건은 오른쪽 아래에서 오르며 라벨을 왼쪽으로 편다.
       두 팔의 라벨 x 대역이 겹치지 않으므로 팔이 다르면 절대 만나지 않고,
       같은 팔 안에서는 세로 간격을 140px 이상 둬서 사건 카드가 펼쳐져도
       (펼침 시 약 104px) 아래 사건을 덮지 않는다. 2024~2025 초반과
       2025 후반~2026이라는 두 시기로도 읽힌다. */
    wide:   { pts:[[.085,.855],[.205,.700],[.330,.545],[.455,.390],[.700,.700],[.790,.530],[.905,.310]],
              sides:['right','right','right','right','left','left','left'], scale:1 },
    /* 태블릿·폴드 내부는 가로가 좁고 세로가 길어 좌우 지그재그가 안전하다.
       한 칸 간격을 무대 높이의 11.7~12%로 잡아 무대 아래쪽을 비우지 않으면서
       사건 카드가 펼쳐질 여유(약 104px)까지 확보한다. 좁은 화면에서 아래가
       텅 빈 채 스크롤만 길어지던 것을 함께 고쳤다. */
    tablet: { pts:[[.175,.180],[.620,.297],[.175,.413],[.620,.530],[.175,.647],[.620,.763],[.175,.880]],
              sides:['right','left','right','left','right','left','right'], scale:.86 },
    mobile: { pts:[[.160,.200],[.720,.315],[.160,.430],[.720,.545],[.160,.660],[.720,.775],[.160,.890]],
              sides:['right','left','right','left','right','left','right'], scale:.76 },
    fold:   { pts:[[.150,.180],[.740,.300],[.150,.420],[.740,.540],[.150,.660],[.740,.780],[.150,.900]],
              sides:['right','left','right','left','right','left','right'], scale:.70 },
  };
